                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('guide.register.submit') }}">
                            ...
                            <div class="form-group{{ $errors->has('home_town') ? ' has-error' : '' }}">
                                <label for="home_town" class="col-md-4 control-label">Home Town</label>

                                <div class="col-md-6">
                                    <input id="home_town" type="text" class="form-control" name="home_town" value="{{ old('home_town') }}" required>
